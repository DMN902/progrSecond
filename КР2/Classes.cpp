...
void transport::SetAll() {
	...
	cout << "Введите вес: ";		weight = GetInt();
	cout << "Введите мощность двигателя: ";		engine_power = GetInt();
	cout << "Введите максимальную скорость: ";		speed = GetInt();
	cout << "_________________________________________________" << endl;
}
...
void truck::SetAll() {
	...
	cout << "Введите максимальную скорость: ";		speed = GetInt();
	cout << "Введите марку: ";						cin >> brand;
	cout << "Введите грузоподъемность:";			capacity = GetInt();
	cout << "_________________________________________________" << endl;
}
